...
class MIRACLTrust {
  ...
  ///
  /// The returned session can be used to complete a cross-device authentication
  /// or signing flow initiated via a QR code.
  ///
  /// Parameters:
  ...
  /// Gets [CrossDeviceSession] from the MIRACL Trust platform using a deep link.
  ///
  /// The returned session can be used to complete a cross-device authentication
  /// or signing flow initiated via a deep link.
  ///
  /// Parameters:
  /// - [link]: A URI received via a deep link.
  ///
  ...
  ///
  /// The returned session can be used to complete a cross-device authentication
  /// or signing flow initiated via a push notification.
  ///
  /// Parameters:
  /// - [payload]: Key-value data provided by the notification.
  ///
