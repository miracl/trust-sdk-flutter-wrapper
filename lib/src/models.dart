...
class ActivationTokenErrorResponse {
  ...
  /// The identifier of the user for which the verification is performed.
  final String userId;
...
class AuthenticationSessionDetails {
  ...
  /// URL for verification in case a custom verification method is used.
...
/// Result returned by the [MIRACLTrust.sign] method.
class SigningResult {
