...
@class NSString;
/// The response returned from <code>MIRACLTrust/MIRACLTrust/getActivationToken(verificationURL:completionHandler:)</code>
/// and <code>MIRACLTrust/MIRACLTrust/getActivationToken(userId:code:completionHandler:)</code>
...
/// Builds <code>Configuration</code> objects.
SWIFT_CLASS_NAMED("Builder")
@interface ConfigurationBuilder : NSObject
/// Initializing <code>Configuration/Builder</code> object.
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
///   </li>
///   <li>
///     projectURL:  <code>Project URL</code> setting for the MIRACL Platform.
///   </li>
///   <li>
...
///   </li>
/// </ul>
- (nonnull instancetype)initWithProjectId:(NSString * _Nonnull)projectId projectURL:(NSString * _Nonnull)projectURL deviceName:(NSString * _Nullable)deviceName OBJC_DESIGNATED_INITIALIZER;
...
/// Set custom <code>Logger</code> writer implementation.
/// \param logger custom <code>Logger</code> implementation.
///
///
/// returns:
/// Configuration.Builder object.
- (ConfigurationBuilder * _Nonnull)loggerWith:(id <Logger> _Nonnull)logger;
/// Sets custom <code>LoggingLevel</code> value. By default it is <code>LoggingLevel/none</code>.
/// This level can be set only for default logger, otherwise will be ignored.
/// \param level custom <code>LoggingLevel</code>
///
///
/// returns:
/// Configuration.Builder object.
...
/// Returns <code>Configuration</code> object.
///
/// throws:
...
SWIFT_CLASS("_TtC11MIRACLTrust18CrossDeviceSession")
@interface CrossDeviceSession : NSObject
/// User ID entered by the user when session is started.
@property (nonatomic, readonly, copy) NSString * _Nonnull userId;
...
/// Configure SDK with values issued by MIRACL and stored in the <code>Configuration</code> object.
...
///
- (BOOL)updateProjectSettingsWithProjectId:(NSString * _Nonnull)projectId projectURL:(NSString * _Nonnull)projectURL error:(NSError * _Nullable * _Nullable)error;
...
/// \param userId identifier of the user identity. To verify identity this identifier needs to be valid email address.
///
/// \param crossDeviceSession the session from which the verification is started.
///
/// \param completionHandler a closure called when the verification has been completed. It can contain a verification response object or an optional error object.
///
- (void)_sendVerificationEmailWithUserId:(NSString * _Nonnull)userId crossDeviceSession:(CrossDeviceSession * _Nullable)crossDeviceSession completionHandler:(void (^ _Nonnull)(VerificationResponse * _Nullable, NSError * _Nullable))completionHandler;
...
/// server for <a href="https://miracl.com/resources/docs/guides/authentication/jwt-verification/">verification</a>.
...
/// Use this method to authenticate another device or application with the usage of  <code>CrossDeviceSession</code>.
...
/// \param completionHandler a closure called when the identity is authenticated. It can contain a boolean flag representing the result of the authentication or an optional error object.
///
- (void)_authenticateWithUser:(User * _Nonnull)user crossDeviceSession:(CrossDeviceSession * _Nonnull)crossDeviceSession didRequestPinHandler:(void (^ _Nonnull)(void (^ _Nonnull)(NSString * _Nullable)))didRequestPinHandler completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler;
/// Get <code>CrossDeviceSession</code> for a QR Code.
/// \param qrCode a string read from the QR code.
///
/// \param completionHandler a closure called when the <code>CrossDeviceSession</code>  is fetched. It can contain a <code>CrossDeviceSession</code> optional object
/// and an optional error object.
///
- (void)_getCrossDeviceSessionFromQRCodeWithQrCode:(NSString * _Nonnull)qrCode completionHandler:(void (^ _Nonnull)(CrossDeviceSession * _Nullable, NSError * _Nullable))completionHandler;
/// Get <code>CrossDeviceSession</code> for an Universal Link.
/// \param universalLinkURL universal link for authentication.
///
/// \param completionHandler a closure called when the <code>CrossDeviceSession</code>  is fetched. It can contain a <code>CrossDeviceSession</code> optional object
/// and an optional error object.
///
- (void)_getCrossDeviceSessionFromUniversalLinkURLWithUniversalLinkURL:(NSURL * _Nonnull)universalLinkURL completionHandler:(void (^ _Nonnull)(CrossDeviceSession * _Nullable, NSError * _Nullable))completionHandler;
/// Get <code>CrossDeviceSession</code> for an Universal Link.
...
/// and an optional error object.
///
- (void)_getCrossDeviceSessionFromPushNotificationPayloadWithPushNotificationPayload:(NSDictionary * _Nonnull)pushNotificationPayload completionHandler:(void (^ _Nonnull)(CrossDeviceSession * _Nullable, NSError * _Nullable))completionHandler;
/// Cancel the <code>CrossDeviceSession</code>.
/// \param crossDeviceSession the session to cancel.
///
/// \param completionHandler a closure called when the <code>CrossDeviceSession</code> is aborted. It can contain a boolean flag representing the result of the abortion and an optional error object.
///
- (void)_abortCrossDeviceSession:(CrossDeviceSession * _Nonnull)crossDeviceSession completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler;
...
/// Generates a signature for a hash provided by the <code>CrossDeviceSession</code> parameter and updates the session.
...
/// \param didRequestSigningPinHandler a closure called when the signing identity PIN code is needed from the SDK. It can be used to show UI for entering the PIN code. Its parameter is another closure that is mandatory to be called after the user finishes their action.
///
/// \param completionHandler a closure called when the signing has completed. It can contain a boolean flag and an optional error object.
///
- (void)_signWithCrossDeviceSession:(CrossDeviceSession * _Nonnull)crossDeviceSession user:(User * _Nonnull)user didRequestSigningPinHandler:(void (^ _Nonnull)(void (^ _Nonnull)(NSString * _Nullable)))didRequestSigningPinHandler completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler;
...
/// Result returned by <code>MIRACLTrust/MIRACLTrust/sign(message:user:didRequestSigningPinHandler:completionHandler:)</code> method.
...
/// A user is uniquely identified by the composite key of (<code>userId</code>, <code>projectId</code>).
/// warning:
/// This object contains sensitive data.
/// Implementers must ensure secure storage (e.g., encryption at rest).
SWIFT_CLASS("_TtC11MIRACLTrust7UserDTO")
...
/// The response returned from <code>MIRACLTrust/MIRACLTrust/sendVerificationEmail(userId:authenticationSessionDetails:completionHandler:)</code>.
