...
private fun deepEqualsPigeon(a: Any?, b: Any?): Boolean {
  ...
  if (a is Map<*, *> && b is Map<*, *>) {
    return a.size == b.size && a.all {
        ...
        deepEqualsPigeon(it.value, b[it.key])
    }
  }
  return a == b
}
...
/** Generated class from Pigeon that represents data sent in messages. */
data class MExceptions (
  val message: String
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): MExceptions {
      val message = pigeonVar_list[0] as String
      return MExceptions(message)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
